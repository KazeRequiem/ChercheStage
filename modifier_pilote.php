...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    if (isset($_POST['pilote_id']) && !empty($_POST['pilote_id'])) {
...
$apiUrl = "https://web4all-api.alwaysdata.net/api/controller/user.php/$piloteId";
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['_method']) && $_POST['_method'] === 'DELETE') {
            ...
            $deleteUrl = "https://web4all-api.alwaysdata.net/api/controller/user.php/$piloteId";
    ...
    $pilote = json_decode($response, true);

    if (!$pilote || !isset($pilote['id_user'])) {
    ...
    echo $twig->render('modifier_pilote.html.twig', [
        'pilote' => $pilote, // Doit contenir les données de l'étudiant, y compris 'id_user'
        'user' => getUserInfo(),
